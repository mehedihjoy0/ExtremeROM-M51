...
DELETE_FROM_WORK_DIR "vendor" "lib/lib_SoundBooster_ver1000.so"
DELETE_FROM_WORK_DIR "vendor" "lib64/lib_SoundBooster_ver1000.so"
...
ADD_TO_WORK_DIR "a52qnsxx" "vendor" "lib/lib_SoundBooster_ver1050.so" 0 0 644 "u:object_r:vendor_file:s0"
ADD_TO_WORK_DIR "a52qnsxx" "vendor" "lib64/lib_SoundBooster_ver1050.so" 0 0 644 "u:object_r:vendor_file:s0"
LOG_STEP_OUT
...
ADD_TO_WORK_DIR "a73xqxx" "vendor" "lib/vendor.samsung.hardware.biometrics.face@2.0.so" 0 0 644 "u:object_r:vendor_file:s0"
...
sed -i '/vendor.samsung.hardware.biometrics.face/,/<\/hal>/ s/version>2\.0</version>3.0</; /vendor.samsung.hardware.biometrics.face/,/<\/hal>/ s/fqname>@2\.0::ISehBiometricsFace\/default</fqname>@3.0::ISehBiometricsFace\/default</' "$WORK_DIR/vendor.m51/etc/vintf/manifest.xml"
LOG_STEP_OUT
...
DELETE_FROM_WORK_DIR "product" "priv-app/HotwordEnrollmentOKGoogleEx3HEXAGON/oat"
