...
SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION=eq_custom,uhq_onoff,karaoke,adapt,spk_stereo,dvfs_20_percent,dvfs_max_45_percent,voice_boost
...
# Fix Dex
SEC_FLOATING_FEATURE_COMMON_CONFIG_DEX_MODE=dual,wireless,standalone
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_WALLPAPER_STYLE=VIDEO,GENWEATHER,FLIPSUIT_LOCK
