...
DOWNLOAD_FIRMWARE()
{
    ...
    if [ "$i" == "$SOURCE_FIRMWARE" ]; then
        ...
        curl -s --retry 5 --retry-delay 5 "https://s03." -o "$ODIN_DIR/${MODEL}_${CSC}/firmware.zip"
        ...
        curl -s --retry 5 --retry-delay 5 "https://s03." -o "$ODIN_DIR/${MODEL}_${CSC}/firmware.zip"
